            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-4 relative z-10">
                <div className="space-y-4 pt-12">
                  <img src={data.bottomSection?.collageImages?.[0] || '/assets/images/aditya-siva-6rDbvXzIVpQ-unsplash-1-scaled.jpg'} alt="Collage 1" className="w-full h-48 object-cover" />
                  <img src={data.bottomSection?.collageImages?.[1] || '/assets/images/rayyu-maldives-xPsFXsbXJRg-unsplash-scaled.jpg'} alt="Collage 2" className="w-full h-56 object-cover" />
                </div>
                <div>
                  <img src={data.bottomSection?.collageImages?.[2] || '/assets/images/ismail-mohamed-sovile-u7qgO97JAEo-unsplash-scaled.jpg'} alt="Collage 3" className="w-full h-[400px] object-cover" />
                  <div className="mt-8">
